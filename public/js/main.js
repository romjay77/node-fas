...
$('.item').click(function() {
	...
	if($('div.items').hasClass('opened')) {
		$('div.items').removeClass('opened')
		toggle();
	}
});
...
$('.toggle').click(function() {
	toggle();
	$('div.items').toggleClass('opened');
});

$('div.items > div > ul > li').click(function() {
	toggle();
	$('div.items').toggleClass('opened');
});
...
function toggle()
{
	let array = $('div.icon > ul > li > a > div > span').toArray();
